...
(function($){$.fn.GoogleMap=function(addresses,titles,details,options){var defaults={type:0,zoom:10,clickable:true,tooltip:true,tipsuffix:' (click for more)'};var options=$.extend(defaults,options);var maptype=getGoogleMapID(options.type);var apiDefaults={mapTypeId:maptype,zoom:options.zoom}
