...
var AustraliaList = function()
{
    ...
    this.sort_col = "nc_states.state_name";
    this.sort_dir = "ASC";
    this.geoCount = 0;
...
{
var objDetail = new AustraliaDetail();
