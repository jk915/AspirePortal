...
//         });  
    ...
    this.bindEvents = function()
    {
        ...
        $("#frmInvestorDetail").submit(function(e)
        {              
            e.preventDefault();
            ...
            if(!$(this).validate(
            {
                errorLabelContainer: $("#frmInvestorDetail div.error"),
                messages: 
                {
        ...
        $("#btnSaveTask").live('click',function(e)
        {
            e.preventDefault();
        ...
        $("#btnAddNote").live('click',function(e)
        {
            e.preventDefault();
...
if(uri == "investors")
{
    var objInvestorList = new InvestorList();
    ...
    {        
        ...
        objInvestorList.init(); 
    }    
}
else
{
    var objInvestorDetail = new InvestorDetail();
