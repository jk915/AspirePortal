...
class Stocklist extends MY_Controller 
{
    ...
    function index($mode = "")
    {
        ...
        $this->data["projects"] = $this->project_model->get_list(1, "", "", $count_all, "", "p.project_name ASC", array(), $builder_id);
    ...
    private function handle_submit_reservation_request()
    {
        ...
        if (!$property) {
            ...
            $emailData = array(
                ...
                'additional_contact_name' => $this->input->post("additional_contact_name"),
