        ...
        <div id="wrapper">
            ...
            <div id="main">  
                ...
                <div class="content inner">
					...
					<div class="sidebar">
                        <?php echo form_open('regions/ajax', array("id" => "frmSearch", "name" => "frmSearch")); ?>
                            ...
                            <input type="hidden" id="action" name="action" value="load_regionlist" />
                    ...
                    <div class="mainCol mainColwidth floatnone">
                        <h1>Regions List</h1>
                        <ul id="tabNav">
