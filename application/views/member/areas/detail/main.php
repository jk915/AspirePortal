            ...
            <div class="content inner">           
			    <div class="mainCol">
			        <div class="heroSlider">
			            <h1><?php echo $area->area_name;?> <span class="price">&nbsp;</span></h1>
                        <ul class="secondary">
                        ...
                        <?php
                            ...
                            foreach($gallery->result() as $doc)
                            {
                                ...
                                $counter++;
                                ?>
                            <img data-thumb="<?php echo $doc->document_path . "_640x452.jpg"; ?>" src="<?php echo $hero; ?>" width="640" height="452" alt="<?php echo $area->area_name;?> Image <?php echo $counter; ?>" />                                
                                <?php
                            }
                        ?>
                        <?php endif; ?>
			            ...
			            <ul class="actions">
                            ...
                            <?php endif; ?>
			                <li class="print"><a href="<?php echo site_url("brochure/area/$area->area_id")?>" target="_blank"><img src="<?php echo base_url()?>images/member/icon-print.png" width="17" height="14" alt="print" />print report</a></li>
			            </ul>
			        <!-- end heroSlider --></div>
			        ...
			        <ul class="tabs">
			            ...
			            <li>
			                ...
			                <ul class="downloads">
                                ...
                                <li><a href="<?php echo base_url(); ?>areas/downloads/<?php echo $doc->document_path; ?>" target="_blank"><?php echo $doc->document_name; ?></a></li>
                                		<?php else : ?>
