<?php
    // Use Google to create a static image of the map for the map australia.
    $floorplan = $map;
?>
<body>
    <div id="wrapper">
            ...
            <div class="content inner">           
			    <div class="mainCol">
			        <div class="heroSlider">
			            <h1><?php echo $australia->australia_name;?> <span class="price">&nbsp;</span></h1>
                        <ul class="secondary">
                        ...
                        ?>
                            <img data-thumb="<?php echo $doc->document_path . "_640x452.jpg"; ?>" src="<?php echo $hero; ?>" width="640" height="452" alt="<?php echo $australia->australia_name;?> Image <?php echo $counter; ?>" />                              
                           
                        <?php endif; ?>
			            </div>  
			            <a id="nextThumb" href="#"></a><a id="prevThumb" href="#"></a> 
			            <div id="floorplan"><img src="<?php echo $hero;?>" width="640" height="452" alt="floorplan" /></div>
			            ...
			            <ul class="actions">
                            ...
                            <?php endif; ?>
			                <li class="print"><a href="<?php echo site_url("brochure/australia/$australia->australia_id")?>" target="_blank"><img src="<?php echo base_url()?>images/member/icon-print.png" width="17" height="14" alt="print" />print report</a></li>
			            </ul>
			        <!-- end heroSlider --></div>
			        
			        <div class="subCol">
                        <h2>Australia Overview</h2>
                        <div class="justify">
                        	<?php echo $australia->overview; ?>
                        </div>
			        </div>
			    ...
			    <div class="sidebar">
			    	<div class="justify">
						<h2> Overview </h2>
                    	<?php echo $australia->short_description; ?>
					</div>
