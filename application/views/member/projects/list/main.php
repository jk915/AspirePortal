        ...
        <div id="wrapper">
            ...
            <div id="main">  
                ...
                <div class="content inner">
                    ...
                    <div class="sidebar">
                        <?php echo form_open('projects/ajax', array("id" => "frmSearch", "name" => "frmSearch")); ?>
                            ...
                            <input type="hidden" id="action" name="action" value="load_projectlist" />
                            ...
                            <!-- Slider Fields -->
                            <input type="hidden" id="min_total_price" name="min_total_price" value="<?=$project_data->min_total_price;?>" />
                            <input type="hidden" id="max_total_price" name="max_total_price" value="<?=$project_data->max_total_price;?>" />                                                                                 
                                                    
                            <fieldset>
                                <ul class="options"> 
                                	<li>
                                        <h3>Price</h3>
                                        <p>From $<span class="lowerVal"><?=$project_data->min_total_price; ?></span> to $<span class="upperVal"><?=$project_data->max_total_price; ?></span></p>
                            ...
                            <li>
                                <table class="zebra listing" cellpadding="0" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            <th class="sortable" sort="p.project_name">Project Name</th>
                                            <th class="sortable" sort="a.area_name">Area</th>
                                            <th class="sortable" sort="s.name">State</th>                                            
                                            <th class="sortable" sort="p.prices_from">Prices From</th>
                                            <th class="sortable" sort="p.rate">Risk</th>
                                        </tr>
                                    </thead>
                                    <tbody>
