...
<div style="text-align: left;padding-left: 50px; padding-right: 50px;">
    ...
    <div class="left">
        ...
        <input id="plan_document_name" type="text" value="<?php echo $file->document_name?>" name="plan_document_name"/>
        <label>Document Description:</label>
        <textarea id="plan_document_description" name="plan_document_description"><?php echo $file->document_description?></textarea>
    </div>
    ...
    <div>
        <input class="button" type="button" value="Save" id="plan_update_files" />
    </div>
    <br/>
</div>
</form>
