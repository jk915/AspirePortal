...
<div style="text-align: left;padding-left: 50px; padding-right: 50px;">
    ...
    <div class="left">
        ...
        <input id="document_name" type="text" value="<?php echo $file->document_name?>" name="document_name"/>
        <label>Document Description:</label>
        <textarea id="document_description" name="document_description"><?php echo $file->document_description?></textarea>
    </div>
    ...
    <div>
        <input class="button" type="button" value="Save" id="update_files" />
    </div>
    <br/>
</div>
</form>
