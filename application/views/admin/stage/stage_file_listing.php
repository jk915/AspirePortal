        ...
        if (file_exists($file_path))
        {
            ...
            ?> 
                <tr class="<?php echo $rowclass;?>">
                    ...
                    <td class="admintabletextcell"><a class="download_stage" href="<?php echo $filename;?>" type="images">Click to download</a></td>
                    <td class="center"><input type="checkbox" name="stage_imagestodelete[]" value="<?php echo $file->id;?>" /></td>
                </tr>                  
            <?php
        }
    }
