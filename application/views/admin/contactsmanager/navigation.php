<div class="intro" style="height:23px">
    <div class="left">
        ...
        <img src="<?=base_url();?>images/admin/i_add.png" border="0" width="16" height="18" alt="Add builder." /> <a href="<?=base_url();?>admin/panelmanager/panel">Add New Panel Solicitor</a>
    </div>
    <div class="right">
